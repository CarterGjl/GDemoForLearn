package aop.demo.jetpack.android.jetpack.widget
...
//
//class PageLayout @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : FrameLayout(context, attrs, defStyleAttr) {
//
//    enum class State {
//        EMPTY_TYPE,
//        LOADING_TYPE,
...
//        mCurrentState = type
//        mLoadingView?.visibility = if (type == State.LOADING_TYPE) View.VISIBLE else View.GONE
...
//        mEmptyView?.visibility = if (type == State.EMPTY_TYPE) View.VISIBLE else View.GONE
...
//            if (mPageLayout.mEmptyView == null) {
//                setDefaultEmpty()
//            }
//            if (mPageLayout.mError == null) {
//                setDefaultError()
//            }
//            if (mPageLayout.mLoadingView == null) {
//                setDefaultLoading()
//            }
//        }
//
//        private fun setDefaultEmpty() {
//            mPageLayout.mEmptyView = mInflater.inflate(R.layout.layout_empty, mPageLayout, false)
//                    .apply {
//                        mTvEmpty = findViewById<TextView>(R.id.tv_page_empty)!!
//                    }
//            mPageLayout.mEmptyView?.visibility = View.GONE
//            mPageLayout.addView(mPageLayout.mEmptyView)
//        }
//
...
//            mPageLayout.mLoadingView = mInflater.inflate(R.layout.layout_loading, mPageLayout, false)
//                    .apply {
...
//                    }
//            mPageLayout.mLoadingView?.visibility = View.GONE
//            mPageLayout.addView(mPageLayout.mLoadingView)
//        }
//
//        /**
//         * 设置loading布局
