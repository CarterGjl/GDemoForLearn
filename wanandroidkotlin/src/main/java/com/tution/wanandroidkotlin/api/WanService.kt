package com.tution.wanandroidkotlin.api

import com.google.gson.JsonObject
import com.tution.wanandroidkotlin.bean.*
...
interface WanService {
    ...
    fun getHomeArticlesAsync(@Path("page") page: Int): Deferred<WanResponse<ArticleList>>

    @GET("/banner/json")
    suspend fun getBanner(): WanResponse<List<Banner>>

    @GET("/banner/json")
    fun getBannerNewAsync(): Deferred<WanResponse<List<Banner>>>
    @GET("/tree/json")
