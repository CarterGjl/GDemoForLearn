...
import aop.demo.jetpack.android.kotlin.impl.repository.model.*
...
interface API {
    ...
    fun getArticleList(@Path(value = "page") page: Int):
            Observable<HttpResponse<ArticleResponseBody<ArticleBean>>>
    ...
    * */
    ...
    @FormUrlEncoded
    @POST("/user/register")
    fun registerC(@Field(value = "username")account: String, @Field(value = "password")password:
    String, @Field(value = "repassword")rPassword: String): Deferred<HttpResponse<LoginBean>>
    /**
     * 我的收藏列表
     *
