package aop.demo.jetpack.android.kotlin.impl.ui.ui.widget;
...
public class LoadMoreAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public LoadMoreAdapter(@NonNull RecyclerView.Adapter<RecyclerView.ViewHolder> adapter) {
        registerAdapter(adapter);
    }

    public LoadMoreAdapter(@NonNull RecyclerView.Adapter<RecyclerView.ViewHolder> adapter, View footerView) {
        registerAdapter(adapter);
        mFooterView = footerView;
    }

    public LoadMoreAdapter(@NonNull RecyclerView.Adapter<RecyclerView.ViewHolder> adapter, @LayoutRes int resId) {
        registerAdapter(adapter);
        mFooterResId = resId;
    }

    private void registerAdapter(RecyclerView.Adapter<RecyclerView.ViewHolder> adapter) {
        if (adapter == null) {
